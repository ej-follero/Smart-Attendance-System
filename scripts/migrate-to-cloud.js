...
function checkDockerStatus() {
 ...
 log(`${colors.yellow} PostgreSQL container not found. Starting Docker services...${colors.reset}`);
 execCommand('docker-compose up -d', 'Starting Docker services');
 }
 } catch (error) {
 log(`${colors.yellow} Starting Docker services...${colors.reset}`);
 execCommand('docker-compose up -d', 'Starting Docker services');
 }
}
...
// Main execution
function main() {
 log(`${colors.bright}${colors.magenta} Database Migration: Docker → Cloud${colors.reset}`);
 log(`${colors.cyan}================================================${colors.reset}`);
