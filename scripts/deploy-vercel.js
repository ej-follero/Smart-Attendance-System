...
function checkPrerequisites() {
 ...
 log(`${colors.yellow} .env.local not found. Make sure to set environment variables in Vercel dashboard${colors.reset}`);
 } else {
...
function validateEnvironment() {
 ...
 log(`${colors.yellow} .env.local not found. Make sure to set these variables in Vercel dashboard:${colors.reset}`);
 requiredEnvVars.forEach(varName => {
