...
const INSTRUCTOR_CONFIG = {
 ...
 // System Information (set INSTRUCTOR_PASSWORD in .env for production; fallback is dev-only)
...
async function createInstructorUser() {
 ...
 if (existingUser) {
 console.log('User with this email already exists:', INSTRUCTOR_CONFIG.email);
 return {
 success: false,
 ...
 console.log(`Generated RFID tag: ${rfidTag}`);
