    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 401) {
          console.warn(`[useUser] Authentication required (401): ${errorText}`);
          setUser(null);
          setProfile(null);
      ...
      console.log('[useUser] Initial attempt failed:', err.message);
      ...
      try {
        ...
        if (isAbortFinal || isTimeoutFinal) {
          ...
          console.log('[useUser] User loading issue:', finalErr.message || finalErr);
        }
