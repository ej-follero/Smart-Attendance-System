...
export default function GuardiansListPage() {
  ...
  // Helper: safe highlight using sanitizer (XSS-safe)
  const highlightMatch = (text: string, matches: readonly [number, number][] | undefined) =>
    safeHighlight(text, matches, 'search-highlight');
  ...
  const highlightSearchTerm = (text: string, searchTerm: string) => {
    ...
    return safeHighlight(text, matches.length ? matches : undefined, 'search-highlight');
  };
