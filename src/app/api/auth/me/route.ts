  ...
  try {
    ...
    if (user.role === 'INSTRUCTOR') {
      ...
      try {
        ...
        console.warn('[AUTH/ME] Instructor fetch failed, continuing without instructor data:', instructorError);
        instructor = null;
      }
    }
    ...
    if (process.env.NODE_ENV === 'development' && e && typeof e === 'object' && 'message' in e) {
      return NextResponse.json({ 
