      ...
      if (includeFlags?.includeCharts && chartImages && typeof chartImages === 'object') {
        ...
        if (modalContentKey && chartImages[modalContentKey]) {
         ...
         /*   doc.setFontSize(14);
            ...
            console.log('[PDF] Modal content added:', finalWidth, 'x', finalHeight, 'at', x, y);
            console.log('[PDF] Page dimensions:', pageWidth, 'x', pageHeight, 'Available:', availableWidth, 'x', availableHeight);
          } catch (error) {
