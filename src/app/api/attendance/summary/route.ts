...
export async function GET(req: NextRequest) {
  try {
    ...
    for (const r of records) {
      // Skip records without a valid subjectSchedId
      if (!r.subjectSchedId) continue;
    ...
    const message = process.env.NODE_ENV === 'development' && e instanceof Error ? e.message : 'Failed to load summary';
